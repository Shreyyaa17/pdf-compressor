...
//     setError(null);
//     setResult(null); // Reset result if they select a new file
...
//     formData.append('level', compressionLevel); // Send the chosen level!
...
//       setResult(data); // Save the stats to show on the success screen
//     } catch (err: any) {
...
//   if (result) {
//     return (
//       <div className="w-full max-w-2xl mx-auto mt-10 p-8 bg-white border rounded-xl shadow-sm text-center">
//         <div className="text-5xl mb-4">🎉</div>
//         <h2 className="text-2xl font-bold text-gray-800 mb-6">PDF Compressed Successfully!</h2>
        
//         <div className="grid grid-cols-2 gap-4 mb-8 text-left bg-gray-50 p-6 rounded-lg">
//           <div>
...
//             <p className="text-lg font-semibold text-green-600">{formatBytes(result.compressedSize)}</p>
//           </div>
//           <div className="col-span-2 border-t pt-4 mt-2">
//             <p className="text-sm text-gray-500">You saved</p>
...
//         {file ? (
//           <div className="text-blue-600 font-semibold">Selected: {file.name} ({formatBytes(file.size)})</div>
//         ) : (
//           <div className="text-gray-600">
//             <p className="text-lg font-medium mb-2">Click or drag a PDF here</p>
//             <p className="text-sm">Maximum file size: {MAX_FILE_SIZE_MB}MB</p>
//           </div>
//         )}
//       </div>
...
//           <h3 className="font-semibold text-gray-700 mb-3">Select Compression Level:</h3>
//           <div className="space-y-3">
//             {[
//               { id: 'extreme', label: 'Extreme Compression', desc: 'Less quality, high compression' },
//               { id: 'recommended', label: 'Recommended', desc: 'Good quality, good compression' },
//               { id: 'low', label: 'Low Compression', desc: 'High quality, less compression' }
//             ].map(lvl => (
//               <label key={lvl.id} className="flex items-start p-3 border rounded cursor-pointer hover:bg-gray-50 transition-colors">
//                 <input 
//                   type="radio" 
//                   name="level" 
//                   value={lvl.id}
...
//           className={`w-full text-white py-4 rounded-lg font-bold text-lg transition-colors shadow-md
//             ${isUploading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
//         >
//           {isUploading ? 'Processing Document...' : 'Compress PDF'}
//         </button>
//       )}
//     </div>
//   );
